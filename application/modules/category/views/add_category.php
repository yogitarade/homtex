...
echo form_open_multipart('category/category/AddCategory', $attributes); ?>
...
<p  style="text-align: center;>
        <label for="category_name" class="common_class">Category Name</label>
...
<p >
<p > 
	<label for="category_name" class="common_class">Add Photo(200 x 200)</label>	
        ...
        <thead>
                <tr role="row">
					...
					<th aria-label="Domain: activate to sort column ascending" style="width: 154px;" colspan="1" rowspan="1" aria-controls="sample-table-2" tabindex="0" role="columnheader" class="sorting">Sr. No.</th>
					 ...
					 <th aria-label="Domain: activate to sort column ascending" style="width: 154px;" colspan="1" rowspan="1" aria-controls="sample-table-2" tabindex="0" role="columnheader" class="sorting">Category Id</th>
				...
				?>
                    ...
                    <tr class="odd">
						...
						<td class=" ">
								   ...
								   <img src ="<?php echo $row->category_image_path; ?>" style="width: 100%;">
                        </td>
                       ...
                       <a class="green" href="<?php echo base_url()?>index.php/category/category/catedit/<?php  
                                 echo $row->ads_category_id;  ?>"> edit
                                </a>

                                <a class="red" href="<?php echo base_url()?>index.php/category/category/deletecat/<?php  
                                     echo $row->ads_category_id;?>"> <i class="icon-trash bigger-130"  onClick="return doconfirm();">delete</i>
                                </a>
