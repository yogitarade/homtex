...
<a href="<?php echo base_url();?>index.php/frontend/frontend/display_category/<?php  echo $row->ads_category_id;?>/<?php echo $row->category_name; ?>"><?php echo $row->category_name; ?></a></h4>
		...
		<div class="features_items">
						<h2 class="title text-center">Products Details</h2>
							<?php
				if($sfunction){
                foreach($sfunction as $sfunction)
				{ 
				?>
					  ...
					  <div class="col-md-12 " style="border: medium solid rgb(242, 222, 222); padding: 1%; margin-bottom: 2%;">
							<div class="row">
										<!-- <div class="col-md-4">
										<img  class="img-responsive"  id="newphoto9" src="<?php echo $sfunction->firm_image; ?>" style="width: 58%;">
									 </div>-->
									  <div class="col-md-6">
                                    ...
                                    <tbody><tr>
                                        ...
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->firm_name; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Firm Contact   </strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->firm_contact; ?></td>
                                    </tr>
                                     <tr>
                                        <td><strong>Firm Address   </strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->firm_address; ?></td>
                                    </tr>
                                     <tr>
                                        <td><strong>Firm Area</strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->firm_area; ?></td>
                                    </tr>
                                     <tr>
                                        <td><strong>Firm City </strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->firm_city; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Person Name</strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->person_name; ?></td>
                                    </tr>
									
									  <tr>
                                        <td><strong>Products</strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->products; ?></td>
                                    </tr>
                                </tbody></table>
                                    ...
                                    <tbody><tr>
                                        ...
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->person_contact; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Person Email Id</strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->person_email_id; ?></td>
                                    </tr>
                                     <tr>
                                        <td><strong>Whatsapp No</strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->whatsup_no; ?></td>
                                    </tr>
                                     <tr>
                                        <td><strong>Website</strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->website; ?></td>
                                    </tr>
                                     <tr>
                                        <td><strong>Specialty</strong></td>
                                        <td width="1">:</td>
                                        <td><?php echo $sfunction->specialty; ?></td>
                                    </tr>
